...
export default function Navbar() {
    return (
        <nav className="flex justify-between items-center px-4 py-6 md:py-10 md:px-14 border-b border-neutral-700">
            ...
            <div className="flex items-center font-bold md:text-xl">
                ...
                <a href="https://github.com/ZachMcM/attack-on-titan-api" className="hover:bg-neutral-800 p-2 md:p-3.5 rounded-md">
