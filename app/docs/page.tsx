    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-3.5 py-10" id="rest">
                ...
                <p className="font-semibold text-lg">Base url: <a href="https://attackontitanapi.com/api" className="font-normal text-sky-400 hover:opacity-80 duration-300">https://attackontitanapi.com/api</a></p>
                ...
                <div className="py-6">
                    <CodeSnippet language={"shell-session"} code="GET https://attackontitanapi.com/api"/>
                ...
                <ul className="list-disc list-inside text-lg ml-10">
                    <li><a href="https://attackontitanapi.com/api/characters" className=" duration-300 text-sky-400 hover:opacity-80">Characters</a>: data on all the characters</li>
                    <li><a href="https://attackontitanapi.com/api/episodes" className=" duration-300 text-sky-400 hover:opacity-80 ">Episodes</a>: data on all the episodes</li>
                    <li><a href="https://attackontitanapi.com/api/locations" className=" duration-300 text-sky-400 hover:opacity-80">Locations</a>: data on all the locations</li>
                    <li><a href="https://attackontitanapi.com/api/organizations" className=" duration-300 text-sky-400 hover:opacity-80">Organizations</a>: data on all the organizations</li>
                    <li><a href="https://attackontitanapi.com/api/titans" className=" duration-300 text-sky-400 hover:opacity-80">Titans</a>: data on all the titans</li>
                </ul>
            </div>  
            <div className="flex flex-col space-y-3.5 py-10" id="info">
                ...
                <div className="py-6">
                    <CodeSnippet language="shell-session" code="GET https://attackontitanapi.com/api/characters"/>
